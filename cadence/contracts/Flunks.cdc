			...
			switch view{ 
				case Type<Flunks.PixelUrl>():
					...
					if pixelUri == nil{ 
						...
						let pixelUrlLen = (pixelUri!).length
						let encodedPart = (pixelUri!).slice(from: pixelUrlLen - 68, upTo: pixelUrlLen)
						return "https://storage.googleapis.com/flunks_public/flunks/".concat(encodedPart)
					}
				...
				case Type<MetadataViews.NFTCollectionDisplay>():
					...
					let logoFull = MetadataViews.Media(file: MetadataViews.HTTPFile(url: "https://storage.googleapis.com/flunks_public/website-assets/banner_2023.png"), mediaType: "image/png")
