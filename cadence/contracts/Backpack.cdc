...
contract Backpack: NonFungibleToken{ 
	...
	resource NFT: NonFungibleToken.NFT, ViewResolver.Resolver{ 
		...
		view fun getViews(): [Type]{ 
			return [Type<MetadataViews.Display>(), Type<MetadataViews.NFTCollectionData>(), Type<MetadataViews.NFTCollectionDisplay>(), Type<MetadataViews.ExternalURL>(), Type<MetadataViews.Edition>(), Type<MetadataViews.Royalties>(), Type<MetadataViews.Traits>()]
		}
		...
		fun resolveView(_ view: Type): AnyStruct?{ 
			switch view{ 
				...
				case Type<MetadataViews.NFTCollectionDisplay>():
					...
					return MetadataViews.NFTCollectionDisplay(name: "Backpack", description: "Backpack #onFlow", externalURL: MetadataViews.ExternalURL("https://flunks.net/"), squareImage: media, bannerImage: media, socials:{ "twitter": MetadataViews.ExternalURL("https://twitter.com/flunks_nft")})
				case Type<MetadataViews.Traits>():
					let excludedTraits = ["mimetype", "uri", "pixelUri", "path", "cid"]
					let metadata = self.getNFTTemplate().getMetadata()
					metadata["slots"] = self.getSlots().toString()
					let traitsView = MetadataViews.dictToTraits(dict: metadata, excludedNames: excludedTraits)
					return traitsView
				case Type<MetadataViews.Edition>():
					return MetadataViews.Edition(name: "Backpack", number: self.templateID, max: 9999)
